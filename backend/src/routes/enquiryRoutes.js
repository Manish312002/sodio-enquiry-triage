 ...
 *
 * Architechure.md §8 API surface (Phase 1 + Phase 2 + Phase 3 subset):
 ...
 *
 * Later phases mount additional routes (PATCH, re-extract) on this same router.
 *
 * NOTE: `/import` is registered BEFORE `/:id` so Express does not match
 * "import" as an id parameter. `/extract` and `/extractions` are registered
