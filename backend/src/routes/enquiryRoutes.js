 ...
 *
 * Architechure.md §8 API surface (Phase 1 + Phase 2 + Phase 3 + Phase 4 + Phase 5 + Phase 6 subset):
 ...
 *
 * Later phases mount additional routes (re-extract, batch progress) on
 * this same router.
 *
 * NOTE: `/import` is registered BEFORE `/:id` so Express does not match
 * "import" as an id parameter. `/extract`, `/extractions`,
 * `/recalculate-priority`, `/status`, and `/fields/:field` are registered
